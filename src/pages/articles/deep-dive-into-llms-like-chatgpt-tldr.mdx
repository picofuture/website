...
### Open Base Models  
**Disclaimer:** The models under discussion **do not strictly follow** the Open Source Initiative (**OSI**) definitions of open-source AI (<a href="https://opensource.org/ai" target="_blank">OSI AI Definition</a>). 
Instead, we use the term **open base models** to describe models where the weights are publicly accessible, but training data and full reproducibility may not be provided.
...
- OpenAI released **<a href="https://github.com/openai/gpt-2" target="_blank">GPT-2</a>**, a fully open-source model.
...
To release a **base model**, two key components are mandatory:
