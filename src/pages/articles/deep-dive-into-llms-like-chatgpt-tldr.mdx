...
#### RLHF Downside
We are doing RL with respect to a lossy simulation of humans. We NEED a reward model that is close to real human preferences, but it's still a simulation—not the real thing. It might be misleading!
...
The ideal strategy for training the reward model is to train it for a few hundred iterations and stop there. If you train it further, it will start to game the system, and performance will decline.
