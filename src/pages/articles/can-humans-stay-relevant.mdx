...
They have literally consumed majority of the text on the public web. You can never compete with that.
...
Professors from stanford believe this exact thing as well. In order to for us to survive this AI revolution, we need to augment ourselves with it's
